...
public class PrivateChatRecordEvent extends AbstractChatRecordEvent {
	...
	public PrivateChatRecordEvent() {
		super();
		setEvent("PrivateChatEvent");
	}
	...
	public void setRecipient(String recipient) {
		eventMap.put(RECIPIENT, recipient);
	}
